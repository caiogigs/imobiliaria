(() => {
  ...
  function initChatbot() {
    ...
    function createOptions() {
      ...
      const opcoes = [
        "Quero entender a administração de locação",
        "Preciso de apoio com contratos",
        "Sou proprietário e quero suporte",
        "Preciso organizar documentos",
        "Outros assuntos"
      ];
  ...
  function initGaleria() {
    ...
    const galerias = {
      completa: [
        { src: "../assets/imagens/administrativo/administrativo1.jpg", legenda: "Gestão administrativa mais organizada" },
        { src: "../assets/imagens/administrativo/administrativo2.jpg", legenda: "Acompanhamento de contratos e informações" },
        { src: "../assets/imagens/administrativo/administrativo3.jpg", legenda: "Suporte voltado à rotina imobiliária" }
      ],
      contratos: [
        { src: "../assets/imagens/administrativo/administrativo2.jpg", legenda: "Organização contratual" },
        { src: "../assets/imagens/administrativo/administrativo4.jpg", legenda: "Documentos e etapas mais claras" },
        { src: "../assets/imagens/administrativo/administrativo1.jpg", legenda: "Fluxo administrativo com mais praticidade" }
      ],
      atendimento: [
        { src: "../assets/imagens/administrativo/administrativo3.jpg", legenda: "Atendimento e suporte personalizado" },
        { src: "../assets/imagens/administrativo/administrativo4.jpg", legenda: "Esclarecimento de dúvidas" },
        { src: "../assets/imagens/administrativo/administrativo2.jpg", legenda: "Direcionamento administrativo" }
      ]
    };
