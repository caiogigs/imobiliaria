(() => {
  ...
  function initChatbot() {
    ...
    function createOptions() {
      ...
      const opcoes = [
        ...
        "Quero anunciar meu imóvel para aluguel",
        "Procuro imóvel comercial para locação",
        "Preciso de orientação sobre locação",
        "Outros assuntos"
      ];
  ...
  function initGaleria() {
    ...
    const galerias = {
      completa: [
        { src: "../assets/imagens/aluguel/aluguel1.jpg", legenda: "Opções de imóveis residenciais para aluguel" },
        { src: "../assets/imagens/aluguel/aluguel3.jpg", legenda: "Locação com atendimento personalizado" },
        { src: "../assets/imagens/aluguel/aluguel4.jpg", legenda: "Busca de imóvel conforme seu perfil" }
      ],
      pintura: [
        { src: "../assets/imagens/aluguel/aluguel2.jpg", legenda: "Imóveis comerciais para locação" },
        { src: "../assets/imagens/aluguel/aluguel5.jpg", legenda: "Espaços para empresas e negócios" },
        { src: "../assets/imagens/aluguel/aluguel4.jpg", legenda: "Atendimento consultivo para locação comercial" }
      ],
      personalizados: [
        { src: "../assets/imagens/aluguel/aluguel3.jpg", legenda: "Atendimento orientado conforme necessidade" },
        { src: "../assets/imagens/aluguel/aluguel5.jpg", legenda: "Consultoria para locação" },
        { src: "../assets/imagens/aluguel/aluguel1.jpg", legenda: "Soluções personalizadas para aluguel" }
      ]
    };
